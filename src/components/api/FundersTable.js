...
export default function FundersTable() {
  ...
  useEffect(() => {
    ...
    apiGet("/api/funders")
      .then((data) => {
        ...
        // API อาจส่ง { data: { "1": {id, title}, ... } } หรือ array หรือ object เดี่ยว
        ...
        if (Array.isArray(payload)) {
          ...
          // แปลง object keyed-by-id เป็น array
  ...
  return (
    <Card>
      <CardHeader
        title="ตารางผู้ให้ทุน /api/funders"
          ...
          <div className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
              <input
                ...
                placeholder="ค้นหา ชื่อผู้ให้ทุน หรือ ID…"
              ...
              <table className="min-w-full bg-white text-sm">
                <thead>
                  <tr className="bg-black/[.03] text-left text-black/60">
                    ...
                    <th className="px-4 py-2 font-medium">ชื่อผู้ให้ทุน</th>
                  </tr>
                </thead>
