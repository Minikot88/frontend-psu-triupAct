// app/(your-page)/FindingdetaillistsTable.jsx
"use client";
...
export default function FindingdetaillistsTable() {
  // ---- state หลัก
          ...
          <div className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
              <input
                ...
                placeholder="ค้นหารายการเผยแพร่ผล หรือรหัส…"
              ...
              >
                <option value="title-asc">ชื่อรายการ (A→Z)</option>
                <option value="title-desc">ชื่อรายการ (Z→A)</option>
              ...
              <table className="min-w-full bg-white text-sm">
                <thead>
                  <tr className="bg-black/[.03] text-left text-black/60">
                    ...
                    <th className="px-4 py-2 font-medium">ชื่อรายการเผยแพร่ผล</th>
                  </tr>
                </thead>
